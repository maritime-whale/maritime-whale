...
print("The 2020-2021 SMA season at Charleston consisted of %d AIS positions" % (len(ch)+10608))
...
print("Post-Panamax ships at Charleston made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season." %
(len(ch[ch["Class"] == "Post-Panamax"].groupby(["MMSI", "Course Behavior"]).mean()),len(ch.groupby(["MMSI", "Class", "Course Behavior"]).mean())+365,100*len(ch[ch["Class"] == "Post-Panamax"].groupby(["MMSI", "Course Behavior"]).mean())/1038))
print("Panamax ships at Charleston made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season." %
(len(ch[ch["Class"] == "Panamax"].groupby(["MMSI", "Course Behavior"]).mean()),len(ch.groupby(["MMSI", "Class", "Course Behavior"]).mean())+365,100*len(ch[ch["Class"] == "Panamax"].groupby(["MMSI", "Course Behavior"]).mean())/1038))
print("Sub-Panamax ships at Charleston made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season.\n" % (365, 1038, 365/1038 * 100))

print("Post-Panamax ships at Savannah made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season." %
(len(sv[sv["Class"] == "Post-Panamax"].groupby(["MMSI", "Course Behavior"]).mean()),len(sv.groupby(["MMSI", "Class", "Course Behavior"]).mean())+497, 100*len(sv[sv["Class"] == "Post-Panamax"].groupby(["MMSI", "Course Behavior"]).mean())/1281))

print("Panamax ships at Savannah made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season." %
(len(sv[sv["Class"] == "Panamax"].groupby(["MMSI", "Course Behavior"]).mean()),len(sv.groupby(["MMSI", "Class", "Course Behavior"]).mean())+497,100*len(sv[sv["Class"] == "Panamax"].groupby(["MMSI", "Course Behavior"]).mean())/1281))

print("Sub-Panamax ships at Savannah made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season.\n" % (497, 1281, 497/1281 * 100))

# print("Post-Panamax ships at Savannah made %d out of %d transits, making up %.2f%% of cargo ship traffic in the 2020-2021 season." % (len(sv[sv["Class"] == "Post-Panamax"].groupby(["MMSI", "Course Behavior"]).mean().index.get_level_values(1)),
