...
def validate_vmr(df):
    ...
    Args:
        df: Vessel movement report generated by vessel finder as pandas DataFrame.
...
def filter_blacklisters(df, blacklist):
    ...
    from the data, and updates the running blacklist.txt file with vessel MMSI's.
...
def import_report(path):
    ...
    Args:
        path: Path to raw vessel movement report generated by vessel finder.
