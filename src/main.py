...
def main():
    ...
    if sync_required:
        ...
        pio.write_html(generate_wspd_hist(stats_data[0], stats_data[2], True), file="../html/wspd_hist_ch.html", auto_open=False)
        pio.write_html(generate_wspd_hist(stats_data[1], stats_data[3], False), file="../html/wspd_hist_sv.html", auto_open=False)
